...
describe('anagram-palindrome', () => {
  it('should return true for possible to make palindrome', () => {
    ...
    const bigContent = fs.readFileSync(
      path.resolve(__dirname, '../test-data/anagram-palindrome-success1.txt'),
      'ascii'
    )
  ...
  it('should return false for if not possible to make palindrome', () => {
    ...
    const bigContent = fs.readFileSync(
      path.resolve(__dirname, '../test-data/anagram-palindrome-fail1.txt'),
      'ascii'
    )
